...
<?php echo CHtml::beginForm('', 'post', array('id'=>'dep_')); ?>
    ...
    <div class="row">
        <?php echo CHtml::label('Укажите количество золота', 'amount_basic'); ?>
    ...
    <div class="row game-button-panel">
        <?php echo CHtml::ajaxLink('Купить золото',
                ...
                array(
                    ...
                    'success' => 'function(response){$("#game-popup-content").fadeOut("low");$("#game-content").html(response);}',
                ),
                array(
                    'id'    => mt_rand(1, 9999),
